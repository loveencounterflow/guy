(function() {
  'use strict';
  var C_cr, C_cr_buffer, C_empty_buffer, C_empty_string, C_lf, C_lf_buffer, H, debug, defaults, misfit, platform, rpr;
  ...
  this._walk_lines_with_positions = function*(path, chunk_size = 16 * 1024) {
    var buffer, eol, eol_cache, flush, has_extra_cr, line_cache, lnr, material, material_byte_idx, offset_bytes, ref, ref1, x_file_byte_idx, y, z;
    line_cache = [];
    eol_cache = [];
    lnr = 0;
    offset_bytes = null;
