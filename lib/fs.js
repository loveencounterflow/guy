(function() {
  ...
  //-----------------------------------------------------------------------------------------------------------
  H.types.declare('guy_walk_lines_cfg', {
    tests: {
  ...
  this.walk_lines = function*(path, cfg) {
    var chunk_size, count, encoding, line, newline, nl_length, ref;
    ...
    //.........................................................................................................
    count = 0;
    ref = this._walk_lines(path, chunk_size, newline, nl_length);
    for (line of ref) {
      count++;
  ...
  //-----------------------------------------------------------------------------------------------------------
  this._walk_lines = function*(path, chunk_size, newline, nl_length) {
    var FS, buffer, byte_count, byte_idx, cache, fd, flush, walk_lines;
    FS = require('node:fs');
    fd = FS.openSync(path);
    cache = [];
    byte_idx = 0;
