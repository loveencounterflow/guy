...
(function() {
  ...
  this.read_latest_version = function(package_name, handler) {
    ...
    (_read_latest_version(package_name)).then((function(_this) {
          ...
          step(function*(resume) {
            ...
            for (dependency_name in ref1) {
              ...
              if ((latest_version = version_cache[dependency_name]) == null) {
                latest_version = (yield _this.read_latest_version(dependency_name, resume));
              ...
              pkgnfo['dependencies'][dependency_name] = {
                version: version,
    ...
    $cast = (function(_this) {
      return function() {
        return $(function(pkgnfo, send) {
          var date, date_by_versions, date_txt, latest_version, line_count, local_version, name, name_display, npm_version, package_name, ref, ref1, results, version;
          ...
          results = [];
          for (name in ref) {
            ref1 = ref[name], version = ref1.version, latest_version = ref1.latest_version;
    ...
    $colorize = (function(_this) {
      return function() {
        ...
        return $(function(row, send) {
          ...
          package_name = row[0], dependency_name = row[1], version = row[2], latest_version = row[3], date = row[4];
  ...
  this.f = function(handler) {
    ...
    package_paths = ['io/jizura-datasources', 'io/hollerith', 'io/hollerith-codec'];
