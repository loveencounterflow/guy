(function() {
  'use strict';
  var CND, Guy, alert, badge, debug, def, def_oneoff, echo, freeze, help, info, isa, lets, log, rpr, type_of, types, urge, validate, warn, whisper;
