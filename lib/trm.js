(function() {
  'use strict';
  var C, H, _inspect, base, get_timestamp, σ_guy;
  ...
  this.rpr = (...P) => {
    ...
    return ((function() {
      ...
      for (i = 0, len = P.length; i < len; i++) {
        x = P[i];
        results.push(_inspect(x, _trm_cfg.rpr));
      }
      return results;
    })()).join(this._trm_cfg.separator);
  };
  ...
  this.inspect = (...P) => {
    ...
    return ((function() {
      ...
      for (i = 0, len = P.length; i < len; i++) {
        x = P[i];
        results.push(_inspect(x, _trm_cfg.inspect));
      }
      return results;
    })()).join(this._trm_cfg.separator);
  };
  ...
  this.pen = (...P) => {
    ...
    return R.join(this._trm_cfg.separator);
  };
